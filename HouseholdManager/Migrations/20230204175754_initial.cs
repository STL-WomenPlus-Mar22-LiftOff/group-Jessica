    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageProperty", x => x.MessagePropertyId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a1addd14-6340-4840-95c2-db12554843e5", 0, "1021dae6-422d-4cd5-a51d-7f6e6c333520", "IdentityUser", "defaultAdmin@yahoo.com", false, true, null, "DEFAULTADMIN@YAHOO.COM", "DEFAULTADMIN@YAHOO.COM", "AQAAAAEAACcQAAAAEAp3iwcjlLiytlfAO6+63CVpwvRPoty4BUUl3W8ImnNpHE9M8E7apNJPwJF6SH3DPA==", "111-222-3333", false, "c318272a-14e8-40cc-ab54-c13dfa77ae78", false, "defaultAdmin@yahoo.com" },
                    { "u1ua87c6-b718-4f48-90a2-458e0a2443e6", 0, "7eeb1468-33a2-40a7-8ada-898d0bd1e11b", "IdentityUser", "defaultUser@yahoo.com", false, true, null, "DEFAULTUSER@YAHOO.COM", "DEFAULTUSER@YAHOO.COM", "AQAAAAEAACcQAAAAEJJ2xrycqdThvIZ8ovrsq7s1F7edEPp0hw2qd1xLdfvYTasIkz7VLOUFNR4Lee38WA==", "111-222-3333", false, "59bd5c72-81ea-437b-988f-63cd639719c2", false, "defaultUser@yahoo.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, new DateTime(2023, 2, 4, 11, 57, 54, 18, DateTimeKind.Local).AddTicks(5501), 2, "Wash dishes", 2, 1 },
                    { 2, false, new DateTime(2023, 2, 4, 11, 57, 54, 18, DateTimeKind.Local).AddTicks(5540), 1, "Make bed", 1, 5 },
                    { 3, false, new DateTime(2023, 2, 4, 11, 57, 54, 18, DateTimeKind.Local).AddTicks(5548), 2, "Make bed", 1, 3 },
                    { 4, false, new DateTime(2023, 2, 4, 11, 57, 54, 18, DateTimeKind.Local).AddTicks(5556), 1, "Mow lawn", 5, 9 },
                    { 5, false, new DateTime(2023, 2, 4, 11, 57, 54, 18, DateTimeKind.Local).AddTicks(5564), 1, "Make dinner", 4, 1 }
                });
